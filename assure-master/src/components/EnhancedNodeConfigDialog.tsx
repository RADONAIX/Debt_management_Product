...
const channelTypes = ["SMS", "Email", "WhatsApp", "IVR", "AI Dialer", "VA", "Push Notification"];
const actionTypes = ["Create PTP", "Send Payment Link", "Generate Settlement", "Create Case", "Credit Validation", "Legal Pre-Notice"];
const conditionTypes = ["No Response?", "PTP Broken?", "If Dispute Detected", "If High-Risk Customer", "If Payment Posted", "If >90 Bucket"];
const aiTypes = ["AI Next-Best-Action", "AI Recommend Channel", "AI Recommend Time-of-Day", "AI Dispute Classifier", "AI Risk Score", "AI PTP Probability"];

export const EnhancedNodeConfigDialog = ({ open, onOpenChange, node, onSave }: EnhancedNodeConfigDialogProps) => {
                    ...
                    <>
                      <div className="space-y-2">
                        ...
                        <Select
                          ...
                          onValueChange={(value) => setConfig({ ...config, dialerType: value })}
                        >
                          <SelectTrigger className="bg-background border-border">
                            <SelectValue />
                          </SelectTrigger>
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) => setConfig({ ...config, contactTimeRange: e.target.value })}
                          className="bg-background border-border"
                        />
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <Select
                          ...
                          onValueChange={(value) => setConfig({ ...config, voicemailLogic: value })}
                        >
                          <SelectTrigger className="bg-background border-border">
                            <SelectValue />
                          </SelectTrigger>
                          <SelectContent>
                            ...
                            <SelectItem value="handover_va">Handover to VA</SelectItem>
                    ...
                    <>
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) => setConfig({ ...config, nLPModel: e.target.value })}
                          className="bg-background border-border"
                        />
                      </div>
                    </>
                  ...
                  <>
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => setConfig({ ...config, installmentCount: parseInt(e.target.value) })}
                        className="bg-background border-border"
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) => setConfig({ ...config, autoCalculateML: checked })}
                      />
                    </div>
                  </>
                )}
                  ...
                  <>
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={(value) => setConfig({ ...config, paymentGateway: value })}
                      >
                        <SelectTrigger className="bg-background border-border">
                          <SelectValue />
                        </SelectTrigger>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => setConfig({ ...config, expiryHours: parseInt(e.target.value) })}
                        className="bg-background border-border"
                      />
                    </div>
                  </>
                ...
                {config.type === "No Response?" && (
                  <>
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        value={config.channelFallback || "SMS → WhatsApp → AI Dialer → Email"}
                        onChange={(e) => setConfig({ ...config, channelFallback: e.target.value })}
                        className="bg-background border-border"
                      />
                    </div>
                  </>
                  ...
                  <>
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={(value) => setConfig({ ...config, gracePeriod: value })}
                      >
                        <SelectTrigger className="bg-background border-border">
                          <SelectValue />
                        </SelectTrigger>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => setConfig({ ...config, escalationRule: e.target.value })}
                        className="bg-background border-border"
                      />
                    </div>
                  </>
                ...
                {config.type === "If High-Risk Customer" && (
                  <>
                    <div className="space-y-2">
                      ...
                      <Textarea
                        value={config.riskBand || "High Risk (Score > 750)\n- Multiple PTP breaks\n- Low payment history"}
                        onChange={(e) => setConfig({ ...config, riskBand: e.target.value })}
                        className="bg-background border-border"
                      />
                    </div>
                  </>
              ...
              <div className="space-y-4 bg-primary/5 p-4 rounded-lg">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="space-y-2">
                        <div className="p-3 bg-background rounded border border-border">
                          ...
                          <p className="text-xs text-muted-foreground mt-1">High SMS engagement history</p>
                        </div>
                        <div className="p-3 bg-background rounded border border-border">
                          <div className="flex justify-between items-center">
                          ...
                          <p className="text-xs text-muted-foreground mt-1">Available during work hours</p>
                        </div>
                      </div>
                    </div>
                  </>
                ...
                {config.type === "AI Recommend Channel" && (
                  <>
                    <div className="space-y-2">
                      ...
                      <div className="space-y-2">
                        {[
                          { channel: "SMS", probability: 78, performance: "High" },
                          { channel: "WhatsApp", probability: 65, performance: "Medium" },
                          { channel: "AI Dialer", probability: 54, performance: "Medium" },
                          { channel: "Email", probability: 32, performance: "Low" }
                        ].map((item) => (
                          <div key={item.channel} className="p-3 bg-background rounded border border-border">
                            <div className="flex justify-between items-center">
                              <span className="font-medium">{item.channel}</span>
                              <div className="flex gap-2">
                                <Badge variant="secondary">{item.probability}%</Badge>
                                <Badge variant={item.performance === "High" ? "default" : "outline"}>
                                  {item.performance}
                                </Badge>
                              </div>
                            </div>
                ...
                {config.type === "AI Recommend Time-of-Day" && (
                  <>
                    ...
                    <div className="p-3 bg-background rounded border border-border">
                      <p className="text-sm"><strong>Engagement Score:</strong> 82%</p>
                      <p className="text-xs text-muted-foreground mt-1">
                        Historical analysis shows 3.2x higher response rate during this window
                      </p>
                    </div>
                  </>
                )}
                ...
                {config.type === "AI Dispute Classifier" && (
                  <>
                    <div className="space-y-2">
                      ...
                      <Input
                        value={config.detectedIntent || "Payment Dispute - Fraud Claim"}
                        onChange={(e) => setConfig({ ...config, detectedIntent: e.target.value })}
                        className="bg-background border-border"
                      />
                    </div>
