import { MessageSquare, Mail, MessageCircle, Phone, Target, FileText, CreditCard, Send, FileCheck, FolderOpen, AlertCircle, HelpCircle, CheckCircle, XCircle, TrendingUp, Scale, FileWarning, Brain, Radio, Clock, FileQuestion, TrendingDown, ShieldAlert, Bell, Link, Tag, Bot, FileSignature, Database, GitMerge, BarChart3 } from "lucide-react";
import { ComponentTile } from "./ComponentTile";
import { Button } from "./ui/button";

interface LeftSidebarProps {
  onStrategyInsights?: () => void;
}

export const LeftSidebar = ({ onStrategyInsights }: LeftSidebarProps) => {
  return (
    <aside className="w-64 bg-sidebar border-r border-sidebar-border overflow-y-auto">
      <div className="p-4">
        ...
        {/* Analytics Section */}
        <div>
          <h4 className="text-xs font-semibold text-primary mb-3 uppercase tracking-wide">Analytics</h4>
          <Button 
            variant="outline" 
            className="w-full justify-start gap-2"
            onClick={onStrategyInsights}
          >
